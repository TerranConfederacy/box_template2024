...
class SquadEquipmentKitNavy : Tracker {
	...
	protected void handleResultEvent(const XmlElement@ event) {
		//squad equipment kit navy notify_script key
		string key = "squad_equipment_kit_navy";
		
		//checking if the event was triggered by a squad equipment kit navy
					...
					if (characterInfo !is null) {
						...
						if (targetKeys.find(soldierClass) != -1 && soldierXp >= 0.1) {
							...
							if (equipment.size() > 0) {
								...
								if (vestAmount == 0 || (vestAmount == 1 && (vestKey == "vest2.carry_item" || vestKey == "vest2_2" || vestKey == "vest2_3" || vestKey == "vest1.carry_item" || vestKey == "vest1_2" || vestKey == "vest2_3" || vestKey == "vest_navy_2" || vestKey == "vest_navy_3" || vestKey == "vest_navy_4"))) {
									string newVest = "vest_navy.carry_item";
